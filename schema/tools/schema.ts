...
/// TBD
public class AuditItem extends Item {
    /// Date of death.
    date: Date
    /// TBD
    content
...
/// programs, etc.
public class CreativeWork extends Item {
...
public class DigitalDocument extends Item {
    constructor(decoder) {
        super()
...
public class MediaObject extends Item {
...
/// TBD
public class CVUStoredDefinition extends Item {
    /// TBD
    definition
    /// TBD
    domain
...
/// TBD
public class Downloader extends Item {
    constructor(decoder) {
        super()
...
/// TBD
public class ImporterRun extends Item {
    /// The name of the item.
    name
    /// TBD
    dataType
...
/// to the database.
public class Indexer extends Item {
    /// The name of the item.
    name
    /// TBD
    icon
...
public class IndexerRun extends Item {
    /// The name of the item.
    name
    /// TBD
    query
...
/// TBD
public class MedicalCondition extends Item {
    /// TBD
    type
    /// The name of the item.
    name
...
/// TBD
public class OnlineProfile extends Item {
    /// TBD
    type
    /// TBD
    handle
...
/// TBD
public class PublicKey extends Item {
    /// TBD
    type
    /// TBD
    key
...
/// TBD
public class SessionView extends Item {
    /// The name of the item.
    name
